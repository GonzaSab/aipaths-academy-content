...
# SEO & Display
title: "Validating Your Idea Before Building: A Framework-Driven Guide"
description: "Learn proven validation frameworks to test your business idea before investing time and money. From smoke tests to pre-sales, discover what separates successful launches from expensive failures."
...
According to [CB Insights research](https://www.cbinsights.com/research/startup-failure-reasons-top/), **42% of startups fail because there's no market need**. Not because the product was bad. Not because the team was incompetent. Because nobody actually wanted what they built.
...
1. [The Psychology of Validation](#the-psychology-of-validation)
2. [The Validation Spectrum: 5 Levels](#the-validation-spectrum)
3. [Level 1: Research Signals](#level-1-research-signals)
4. [Level 2: Problem Interviews](#level-2-problem-interviews)
5. [Level 3: Smoke Tests](#level-3-smoke-tests)
6. [Level 4: Pre-Sales](#level-4-pre-sales)
7. [Level 5: Concierge MVP](#level-5-concierge-mvp)
8. [Setting Success Metrics](#setting-success-metrics)
9. [What the Data Tells You](#what-the-data-tells-you)
10. [Real-World Case Studies](#real-world-case-studies)
11. [The Validation Scorecard](#the-validation-scorecard)
...
**What you're testing:** Is this problem urgent enough to solve?
...
Named after Rob Fitzpatrick's essential book, [The Mom Test](http://momtestbook.com/), this framework prevents the most common interview mistake: asking questions that generate false positives.
...
**Opening (2 min):**
"Thanks for taking the time. I'm researching how [target audience] handle [problem area]. I'm not selling anything—just trying to understand the landscape. Mind if I ask some questions about your experience?"
...
1. Specific pain points mentioned (exact words they used)
2. Current solutions they've tried
3. Money/time already spent on the problem
4. Urgency signals (or lack thereof)
5. Would they take a follow-up action? (beta test, call, etc.)
...
**Effort:** Medium (20-40 hours + small ad budget)
**Confidence:** Medium-High
**What you're testing:** Will people take action, not just talk?
...
1. **Landing Page MVP** - A single page describing your offer with a signup/buy button
2. **Fake Door Test** - A button or feature that doesn't work yet, measuring clicks
3. **Explainer Video** - A video showing how the product would work
4. **Waitlist** - A signup for early access
5. **Coming Soon Page** - Announce the product with an email capture
...
Research shows that [response biases like "yea-saying"](https://cxl.com/blog/smoke-test/) make interview data unreliable. Smoke tests measure what people do, not what they say they'll do.
...
- [Carrd](https://carrd.co) - $19/year, dead simple
- [Framer](https://framer.com) - Free tier, more design flexibility
- [Webflow](https://webflow.com) - More complex, more powerful
- [Typedream](https://typedream.com) - Notion-like simplicity

For a complete guide on creating a professional landing page, check out our [SaaS Landing Page Template](https://www.aipaths.academy/es/resources/003_saas-landing-template).
...
1. **Visitor-to-signup rate** (most important)
...
**How it works:**
1. User clicks "Buy Now" or "Start Free Trial"
2. They're taken to a page that says: "Thanks for your interest! We're launching soon. Enter your email to get notified and receive a special early-bird discount."
3. You measure how many people clicked vs. entered email
...
**Confidence:** High
**What you're testing:** Will people actually pay money?
...
1. **Your smoke test signups** - These people already showed interest
2. **Interview participants** - Especially those who showed urgency
3. **Warm network** - LinkedIn connections in target industry
4. **Communities** - Facebook groups, Slack channels, Discord servers
5. **Cold outreach** - LinkedIn/email to target decision-makers
...
**What you're testing:** Can you actually deliver value?
...
1. **Learn deeply:** You'll understand edge cases, exceptions, and real customer needs that you'd never discover otherwise
2. **Iterate quickly:** Changing a process takes minutes; changing code takes hours/days
3. **Deliver immediately:** Customers get value now, not "when the product is ready"
4. **Reduce risk:** If the manual process doesn't work, you haven't wasted development time
...
*Manual process:*
1. Client sends product spreadsheet weekly
2. You use Claude to generate descriptions
3. You review and edit for brand voice
4. You send back formatted for their platform
...
*Manual process:*
1. Client forwards support emails to you
2. You draft responses using Claude
3. You review for accuracy
4. You send back to client (or send directly with their permission)
...
**What they did:**
1. Posted their apartment on Craigslist
2. Manually coordinated bookings via email
3. Took professional photos of listings themselves
4. Met with hosts personally to onboard them
5. Handled every customer service issue individually
...
**Views** tell you reach (mostly vanity)
**Clicks** tell you interest
**Signups** tell you intent
**Pre-orders** tell you serious intent
**Revenue** tells you actual demand
...
Be specific: "If 10% of landing page visitors sign up for the waitlist within 2 weeks, we proceed."

**2. What constitutes failure?**
Be specific: "If fewer than 3% sign up after 500 visitors, we pivot our positioning."

**3. What's the minimum sample size?**
Don't make decisions on small numbers. Minimum 100-200 data points for most metrics.

**4. What's the timeframe?**
Give it enough time: 2-4 weeks for most smoke tests.
...
1. Change your messaging/positioning
2. Change your target audience
3. Change your channel/distribution
...
Joel Gascoigne created a [landing page MVP](https://medium.com/@joelgascoigne/how-to-successfully-validate-your-idea-with-a-landing-page-mvp-ef3c2d02dc51) with just:
...
1. Posted on forums and communities about the problem
2. Manually connected apps for early users
3. Built integrations one at a time based on actual demand
4. Only automated what they'd already proven manually
...
**The process:**
1. Curated daily product finds
2. Sent email to small list
3. List grew through word-of-mouth
4. Only built the full site after proving demand
...
**Total Green Flags:** ___
**Total Red Flags:** ___
**Net Score:** ___ (Green - Red)
...
Create a simple landing page to test your messaging. Check out our [SaaS Landing Page Template](https://www.aipaths.academy/es/resources/003_saas-landing-template) for a ready-to-use starting point.
...
Check out our [SaaS Landing Page Template](https://www.aipaths.academy/es/resources/003_saas-landing-template) for a ready-to-use starting point.
